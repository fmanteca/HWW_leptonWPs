//root -l -q -b "PlotVariables.C(\"Tight\", \"mm\",\"high\",\"0j\")"
...
void PlotVariables(TString muonWP, TString channel, TString pt2_cut, TString njet)
{
  TH1::SetDefaultSumw2();
  std::cout << std::fixed;
  ...
  //TFile* root_output = new TFile("/afs/cern.ch/work/a/alvareza/public/CMSSW_10_1_0/src/myMacros/for_Adrian/variables_muonWP_"+muonWP+"_"+channel+"_pt2_cut_"+pt2_cut+"_"+njet+".root", "recreate");
  ...
  can[0]->SaveAs("histogram_pt1_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");  
  ...
  can[1]->SaveAs("histogram_pt2_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
 THStack h_eta1("h_eta1","eta1"); can[2]->cd();
  ...
  can[2]->SaveAs("histogram_eta1_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[3]->SaveAs("histogram_eta2_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[4]->SaveAs("histogram_MET_pt_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[5]->SaveAs("histogram_mpmet_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[6]->SaveAs("histogram_mth_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[7]->SaveAs("histogram_mtw2_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[8]->SaveAs("histogram_mll_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
  ...
  can[9]->SaveAs("histogram_ptll_muonWP_"+muonWP+"_"+channel+"_pt2cut_"+pt2_cut+"_"+njet+".png");
